...
const TopList = require('../../common/toplist.js').TopList;
...
exports.add = function (req, res, resp, onReqHandled) {
    do {
        if (!req.args.legion) {
...
exports.getRanks = function (req, res, resp, onReqHandled) {
    do {
