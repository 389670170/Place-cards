...
// 城池占领
exports.city_owner_change = function (req, res, resp, onReqHandled) {
    var players = req.args.players;
...
// 城池战斗状态改变
exports.city_fight_state_change = function (req, res, resp, onReqHandled) {
    var players = req.args.players;
    var city = req.args.city;
    var cityInfo = req.args.cityInfo;
...
// 城池人员变动
exports.city_player_change = function (req, res, resp, onReqHandled) {
    var players = req.args.players;
    var city = req.args.city;
...
// 连斩通知
exports.continuous_kill = function (req, res, resp, onReqHandled) {
    var players = req.args.players;
...
// 击杀玩家
exports.kill_player = function (req, res, resp, onReqHandled) {
    var players = req.args.players;
    var city = req.args.city;
    var killer = req.args.uid;
    var killerName = req.args.un;
...
exports.on_player_fight = function (req, res, resp, onReqHandled) {
    var players = req.args.players;
    var city = req.args.city;
...
exports.sync_move = function (req, res, resp, onReqHandled) {
    var players = req.args.players;
