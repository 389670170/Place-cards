var { loadGlobalServerConf } = require('../../common/server.js')
...
exports.world_get = function (req, res, resp, onReqHandled) {
...
exports.sync_server_info = function (req, res, resp, onReqHandled) {
