// 领地战逻辑
// 玩家位置改变
exports.player_position_change = function (req, res, resp, onReqHandled) {
...
// 玩家进入领地通知
exports.player_enter = function (req, res, resp, onReqHandled) {
    var players = req.args.players;
    var uid = req.args.uid;
    var lid = req.args.lid;
    var un = req.args.un;
...
// 玩家离开领地通知
exports.player_leave = function (req, res, resp, onReqHandled) {
    var players = req.args.players;
    var uid = req.args.uid;
    var pos = req.args.pos;
...
// 领地战重置
exports.reset_by_week = function (req, res, resp, onReqHandled) {
...
// 军团开启传送门
exports.open_transfer_gate = function (req, res, resp, onReqHandled) {
    var lid = req.args.lid;
...
// 石碑访问
exports.visit_stele = function (req, res, resp, onReqHandled) {
    var players = req.args.players;
    var lid = req.args.lid;
    var cellId = req.args.cellId;
...
// 瞭望塔访问
exports.visit_tower = function (req, res, resp, onReqHandled) {
    var players = req.args.players;
    var lid = req.args.lid;
    var cellId = req.args.cellId;
...
// 军团成员访问格子
exports.legion_member_visit_cell = function (req, res, resp, onReqHandled) {
    var players = req.args.players;
    var lid = req.args.lid;
    var cellId = req.args.cellId;
...
// 怪物死亡通知
exports.monster_dead = function (req, res, resp, onReqHandled) {
    var players = req.args.players;
    var lid = req.args.lid;
    var cellId = req.args.cellId;
...
// 被踢出领地战
exports.kick_player = function (req, res, resp, onReqHandled) {
    var players = req.args.players;
...
// 战斗状态改变
exports.fight_state_change = function (req, res, resp, onReqHandled) {
    var players = req.args.players;
    var uid = req.args.uid;
...
;
// boss出生
exports.boss_birth = function (req, res, resp, onReqHandled) {
    var players = req.args.players;
...
// 玩家血量改变
exports.player_hp_change = function (req, res, resp, onReqHandled) {
    var players = req.args.players;
    var uid = req.args.uid;
...
// 共享怪物血量改变
exports.monster_hp_change = function (req, res, resp, onReqHandled) {
    var players = req.args.players;
    var cellId = req.args.cellId;
    var stayingPower = req.args.staying_power;
