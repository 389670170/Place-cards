...
UserInfo.prototype = {
    init: function (callback) {
        gDBWorld.find({ _id: 'user' }).limit(1).next(function (err, doc) {
            if (doc) {
                ...
                for (var level in conf_mgr.gConfVip) {
    ...
    _init: function (callback) {
        ...
        //         if (!tActInfo.stage || tActInfo.stage == conf_mgr.gConfActivities["open_rank_recharge"].startTime) {
        ...
        //         if (!tActInfo.stage || tActInfo.stage == conf_mgr.gConfActivities["open_rank_expense"].startTime) {
    ...
    getUserQuality: function (uid) {
        ...
        if (user) {
            if (user.custom_king.index > 0) {
                //quality = conf_mgr.gConfCustomKing[user.custom_king.chapter][user.custom_king.index].quality;
            }
        }
    ...
    getHeroFightForceNoFate: function (uid, pos) {
        ...
        //var fateFightForce = calcFightForce(posObj, conf_mgr.gConfAttPrCoEff[posObj.level]);
        return fightForce - 0;
    },
    ...
    resetByDay: function () {
        ...
        var tRechargeStartTime = conf_mgr.gConfActivities["open_rank_recharge"].startTime;
        var tRechargeEndTime = conf_mgr.gConfActivities["open_rank_recharge"].endTime + (24 * 60 * 60 * conf_mgr.gConfActivities["open_rank_recharge"].delayDays);
        ...
        var tExpenseStartTime = conf_mgr.gConfActivities["open_rank_expense"].startTime;
        var tExpenseEndTime = conf_mgr.gConfActivities["open_rank_expense"].endTime + (24 * 60 * 60 * conf_mgr.gConfActivities["open_rank_expense"].delayDays);
...
exports.login = function (req, res, resp, onReqHandled) {
    var uid = req.uid;
    do {
        ...
        function checkTips_callback() {
            ...
            if (common.getTime() >= common.GLOBAL_SERVER_INFO_DICT.worldWarOpenTime && isModuleOpenByWorld(gUserInfo.users[uid], 'worldwar')) {
                var worldWarResp = {};
...
//登录前获取world所需信息
exports.getWorldInfo = function (req, res, resp, onReqHandled) {
    var uid = +req.uid;
    var jadeLastCount = 0;
...
// 空着即可，因为此请求前已经调用了更新
exports.update = function (req, res, resp, onReqHandled) {
    onReqHandled(res, resp, 1);
};

exports.set_name = function (req, res, resp, onReqHandled) {
    do {
...
exports.rank_list = function (req, res, resp, onReqHandled) {
    ...
    var rankCnt = conf_mgr.gConfGlobal.rankListLimit_fight;
...
exports.level_rank_list = function (req, res, resp, onReqHandled) {
    var rankList = [];
    var iter = gUserInfo.lvRanks.iterator();
    var item = null;

    var rankCnt = conf_mgr.gConfGlobal.rankListLimit_level;
    while (rankList.length != rankCnt && (item = iter.next()) != null) {
        var uid = item[0];
        var user = gUserInfo.getUser(uid);
        var rank = {
...
exports.test_sys_mail = function (req, res, resp, onReqHandled) {
...
exports.get_honor_hall = function (req, res, resp, onReqHandled) {
...
exports.get_honor_user = function (req, res, resp, onReqHandled) {
    do {
...
exports.send_bullet = function (req, res, resp, onReqHandled) {
    var target = req.args.target;
    var type = req.args.type;
...
exports.get_main_city = function (req, res, resp, onReqHandled) {
    // 检查军团战TIPS
...
exports.get_honor_bullet = function (req, res, resp, onReqHandled) {
    resp.data.bullet = gUserInfo.getHonorUserBullet(req.args.target);
    onReqHandled(res, resp, 1);
};

exports.get_tips = function (req, res, resp, onReqHandled) {
    resp.data.tips = gTips.getTips(req.uid);
    onReqHandled(res, resp, 1);
};

exports.update_user_rank_recharge = function (req, res, resp, onReqHandled) {
    gUserInfo.updatePlayerRank("activity.rank.recharge", req.uid, req.args.data)
}

exports.update_user_rank_expense = function (req, res, resp, onReqHandled) {
    gUserInfo.updatePlayerRank("activity.rank.expense", req.uid, req.args.data)
}

exports.debug_world_user = function (req, res, resp, onReqHandled) {
    resp.data.user = gUserInfo.getUser(req.uid);
    onReqHandled(res, resp, 1);
};

exports.reset_world = function (req, res, resp, onReqHandled) {
    gMine.mine = {};
    gMine.dirty = {};
...
exports.get_title = function (req, res, resp, onReqHandled) {
    resp.data.title = gUserInfo.getTitle(req.uid);
    onReqHandled(res, resp, 1);
};

exports.get_fight_force_top = function (req, res, resp, onReqHandled) {
    resp.data.top = gUserInfo.getHonorTopUid();
    onReqHandled(res, resp, 1);
};

exports.get_lucky_top = function (req, res, resp, onReqHandled) {
    resp.data.top = gTavern.getHonorTopUid();
    onReqHandled(res, resp, 1);
};

// 更新皇城俸禄
exports.update_salary = function (req, res, resp, onReqHandled) {
    var uid = req.uid;
...
//
exports.updateEquitInfo = function (req, res, resp, onReqHandled) {
