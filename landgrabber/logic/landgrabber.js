...
LandGrabber.prototype = {
        ...
        if (this.villages[village_id] && this.villages[village_id].team_id) {
            ...
            for (var k in teamInfo.member_list) {
                ...
                if (awardArr[memberUid] > 0) {
                    var awards = [[]];
                    awards[0][0] = conf_mgr.gConfTeamLand[village_id].resourceReserve[0][0];
                    awards[0][1] = conf_mgr.gConfTeamLand[village_id].resourceReserve[0][1];
    ...
    getLandDailyRemainTime: function (uid) {
        //var notUseTime = this.notUseTime[owner] || 0;   // 昨日未用时间
        //var holdTime = this.dailyLandHoldTime[owner] || 0;
        var remainTime = conf_mgr.gConfGlobal.territoryWarPersonalMaxHour * 3600;// + notUseTime - holdTime;
        return remainTime;
    },
};
...
// 队伍队长改变
exports.village_team_leader_change = function (req, res, resp, onReqHandled) {
    do {
        var teamId = req.args.team_id;
...
exports.village_member_check = function (req, res, resp, onReqHandled) {
