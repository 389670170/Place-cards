...
exports.EVENT = {
    ...
    SPEED_UP: "speed_up",
    /** 捕获哥布林 */
    GET_GOBLIN: "get_goblin",
    /** 领取龙晶洞穴宝箱 宝箱等级 */
    DIGGING_BOX: "digging_box",
    /** 合成英雄 合成的英雄等级 */
    MAKE_HERO_UP: "make_hero_up",
    /** 触发支付操作 cash, chargeId, gift_key, gift_id */
    ON_PAY: "on_pay",
    /** 用户招募 type 1为普通 2为高级 */
    PLAYER_RECRUIT: "player_recruit",
    /** 用户领取邮件 mail */
    GET_MAIL: "get_mail",
    /** 深渊世界 通关 progress:关卡数 star:星数 is_first:是否为首通 */
    ABYSS_PROGRESS: "abyss_progress",
    /** 深渊世界 获取宝箱  id:宝箱id */
    ABYSS_GET_BOX: "abyss_get_box",
    /** 消耗钻石（任何颜色）  num:数量 */
    COST_MIX_CASH: "cost_mix_cash",
    /**  */
    DO_TASK: "do_task",
    /**  */
    DO_DAILY_TASK: "do_daily_task",
}