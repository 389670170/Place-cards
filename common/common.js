...
global.RankTree = require('./ranktree.js').RankTree;
...
global.getClientIp = exports.getClientIp = function (req) {
...
exports.isBase64 = function (str) {
    ...
    if (str.indexOf(".html") != -1) { return false; }
    if (str.indexOf(".css") != -1) { return false; }
    if (str.indexOf(".js") != -1) { return false; }
    if (str.indexOf(".gif") != -1) { return false; }
    if (str.indexOf(".png") != -1) { return false; }
    if (str.indexOf(".jpg") != -1) { return false; }
    if (str.indexOf(".ico") != -1) { return false; }
    if (str.indexOf(".dat") != -1) { return false; }
    if (str.indexOf("=") != -1 && str.indexOf("=") != (str.length - 1) && str.indexOf("==") != (str.length - 2)) { return false; }
    return true;
}
...
/** 获取玩家数据快照 */
exports.user_snapshot_data = function (user) {
    var tResultData = {};
    if (user) {
...
/** 服务器启动时间 */
exports.SERVER_START_TIME = getTime();
/** 所有服务器信息 */
exports.GLOBAL_SERVER_INFO_DICT = {};
