...
global.LOG = exports.LOG = function (content) {
    logger.info(content);
};

global.DEBUG = exports.DEBUG = function (content) {
    logger.debug(content);
};

global.ERROR = exports.ERROR = function (content) {
    elogger.error(content);
};

global.INFO = exports.INFO = function (content) {
