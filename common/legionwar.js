...
exports.getSchedule = function () {
    ...
    for (var type in conf_mgr.gConfLegionWarSchedule) {
        if (!conf_mgr.gConfLegionWarSchedule.hasOwnProperty(type)) {
            continue;
        }

        var typeSchedule = conf_mgr.gConfLegionWarSchedule[type];
...
exports.genStageEndTime = function (stage, next) {
    var stageConf = conf_mgr.gConfLegionWarSchedule[stage];
...
exports.getRank = function (score) {
    for (var id in conf_mgr.gConfLegionWarRank) {
        if (!conf_mgr.gConfLegionWarRank.hasOwnProperty(id)) {
            continue;
        }

        var rankConf = conf_mgr.gConfLegionWarRank[id];
