...
var Robot = {
    ...
    genMember: function (member) {
        // 生成阵容数据
        var fightInfo = randomPosObj(conf_mgr.gConfRobot, Object.keys(member.fight_info.pos).length, // 上阵人数
            member.fight_force
        );
        ...
        var member = {
            ...
            model: model,
            quality: conf_mgr.gConfHero[fightInfo[1].hid].quality,
        };
