...
// 拉
exports.get_info = function (req, res, resp, onReqHandled) {
...
// 转
exports.rotate = function (req, res, resp, onReqHandled) {
    do {
        ...
        var data = gActLuckyRotation.data[type];
        var conf = conf_mgr.gConfAvLuckyRotateBase[type];
...
// 记录：存抽中的道具大奖
exports.list_add = function (req, res, resp, onReqHandled) {
